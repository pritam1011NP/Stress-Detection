...
# Modified Version
This fork adds:
- `Code/main.py` a merged entrypoint using MediaPipe for landmarks (no dlib required)
- Live stress score (0-100), CSV logging, and final stress trend plot
- Better overlays and progress bar

## Run
Install requirements from `dependencies_modified.txt` then:
```
python Code/main.py --source 0
```
